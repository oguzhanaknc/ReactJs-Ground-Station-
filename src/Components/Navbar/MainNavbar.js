    ...
    render() {
        ...
        <div>
            <Navbar color="dark" light expand="md">
                <NavbarBrand className="text-white" href="/">Mini İHA için Yapay Zeka Tabanlı Anomali Tespiti ve Semantik Seyrüsefer Demosu</NavbarBrand>
                    ...
                    <UncontrolledDropdown nav inNavbar >
                        ...
                        <DropdownMenu right>
                            ...
                            <DropdownItem>
                                <FormControlLabel
                                    value="start"
                                    control={<Switch color="primary" onChange={this.NightMode}  />}
